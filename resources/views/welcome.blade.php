...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sistema PAE - Programa de Alimentación Escolar</title>
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <div class="flex lg:justify-center lg:col-start-2">
                            <div class="text-center">
                                <div class="flex items-center justify-center gap-4 mb-4">
                                    <img src="{{ asset('images/logo-colegio-actual.png') }}" alt="Logo Colegio" class="h-16 w-auto lg:h-20">
                                </div>
                                <h1 class="text-2xl font-bold text-white lg:text-3xl lg:text-[#FF2D20] mb-2">Sistema PAE</h1>
                                <p class="text-sm text-white/80 lg:text-gray-600 mb-2">Programa de Alimentación Escolar</p>
                                <p class="text-xs text-white/70 lg:text-gray-500 font-medium">Institución Educativa Brighton Pamplona</p>
                            </div>
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        ...
                        <div class="grid gap-6 lg:grid-cols-4 lg:gap-8 mb-8">
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/20">
                                ...
                                <div class="pt-1">
                                    <h3 class="text-lg font-semibold text-black dark:text-white">{{ \App\Models\Beneficiario::activos()->count() }}</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Beneficiarios Activos</p>
                                </div>
                            </div>

                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/20">
                                ...
                                <div class="pt-1">
                                    <h3 class="text-lg font-semibold text-black dark:text-white">{{ \App\Models\Entrega::count() }}</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Total Entregas</p>
                                </div>
                            </div>

                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900/20">
                                ...
                                <div class="pt-1">
                                    <h3 class="text-lg font-semibold text-black dark:text-white">{{ \App\Models\Producto::count() }}</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Productos Registrados</p>
                                </div>
                            </div>

                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/20">
                                ...
                                <div class="pt-1">
                                    <h3 class="text-lg font-semibold text-black dark:text-white">{{ \App\Models\Entrega::where('estado', 'abierta')->count() }}</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Entregas Abiertas</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Beneficiarios por Grado</h2>
                                </div>
                                <div class="space-y-3">
                                    @php
                                        $beneficiariosPorGrado = \App\Models\Beneficiario::activos()
                                            ->selectRaw('grado, COUNT(*) as total')
                                            ->groupBy('grado')
                                            ->orderBy('grado')
                                            ->get();
                                    @endphp
                                    @forelse($beneficiariosPorGrado as $grado)
                                        <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            <span class="font-medium text-gray-700 dark:text-gray-300">{{ $grado->grado }}</span>
                                            <span class="text-lg font-semibold text-blue-600 dark:text-blue-400">{{ $grado->total }}</span>
                                        </div>
                                    @empty
                                        <p class="text-gray-500 dark:text-gray-400 text-center py-4">No hay beneficiarios registrados</p>
                                    @endforelse
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Entregas Recientes</h2>
                                </div>
                                <div class="space-y-3">
                                    @php
                                        $entregasRecientes = \App\Models\Entrega::with('racion')
                                            ->orderBy('fecha', 'desc')
                                            ->limit(5)
                                            ->get();
                                    @endphp
                                    @forelse($entregasRecientes as $entrega)
                                        <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            <div>
                                                <p class="font-medium text-gray-700 dark:text-gray-300">{{ $entrega->fecha->format('d/m/Y') }}</p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $entrega->racion->nombre ?? 'Sin ración' }}</p>
                                            </div>
                                            <span class="px-2 py-1 text-xs rounded-full {{ $entrega->estado === 'abierta' ? 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400' }}">
                                                {{ $entrega->estado === 'abierta' ? 'Abierta' : 'Cerrada' }}
                                            </span>
                                        </div>
                                    @empty
                                        <p class="text-gray-500 dark:text-gray-400 text-center py-4">No hay entregas registradas</p>
                                    @endforelse
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Estado del Inventario</h2>
                                </div>
                                <div class="space-y-3">
                                    @php
                                        $inventarioProductos = \App\Models\Inventario::with('producto.presentacionProducto')
                                            ->where('activo', true)
                                            ->limit(5)
                                            ->get();
                                    @endphp
                                    @forelse($inventarioProductos as $inventario)
                                        <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            <div>
                                                <p class="font-medium text-gray-700 dark:text-gray-300">{{ $inventario->producto->nombre ?? 'Producto no encontrado' }}</p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $inventario->producto->presentacionProducto->nombre ?? 'Sin presentación' }}</p>
                                            </div>
                                            <span class="text-lg font-semibold {{ $inventario->cantidad_stock > 10 ? 'text-green-600 dark:text-green-400' : ($inventario->cantidad_stock > 5 ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400') }}">
                                                {{ $inventario->cantidad_stock }}
                                            </span>
                                        </div>
                                    @empty
                                        <p class="text-gray-500 dark:text-gray-400 text-center py-4">No hay productos en inventario</p>
                                    @endforelse
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Información del Sistema</h2>
                                </div>
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Versión del Sistema</span>
                                        <span class="font-semibold text-purple-600 dark:text-purple-400">PAE v1.0</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Última Actualización</span>
                                        <span class="font-semibold text-purple-600 dark:text-purple-400">{{ now()->format('d/m/Y') }}</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Estado del Sistema</span>
                                        <span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400">Operativo</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Usuarios Registrados</span>
                                        <span class="font-semibold text-purple-600 dark:text-purple-400">{{ \App\Models\User::count() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        <div class="space-y-2">
                            <p class="font-semibold">Sistema PAE - Programa de Alimentación Escolar</p>
                            <p class="text-gray-600 dark:text-gray-400 font-medium">
                                Institución Educativa Brighton Pamplona
                            </p>
                            <p class="text-gray-600 dark:text-gray-400">
                                Gestión integral de beneficiarios, entregas e inventario
                            </p>
                            <div class="flex justify-center items-center gap-4 mt-4 text-xs text-gray-500 dark:text-gray-400">
                                <span>Laravel v{{ Illuminate\Foundation\Application::VERSION }}</span>
                                <span>•</span>
                                <span>PHP v{{ PHP_VERSION }}</span>
                                <span>•</span>
                                <span>{{ now()->format('Y') }} - Todos los derechos reservados</span>
                            </div>
                        </div>
                    </footer>
                </div>
