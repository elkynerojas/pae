...
class ShowPastelPalettes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'theme:show-pastels';
     ...
     * @var string
     */
    protected $description = 'Muestra diferentes paletas de colores pasteles claros';
    ...
    {
        $this->info('🎨 Paletas de Colores Pasteles Claros para Filament');
        $this->newLine();
        ...
        foreach ($palettes as $key => $palette) {
            $this->info("🎨 {$palette['name']}");
            $this->line("   {$palette['description']}");
        ...
        $this->info('💡 Para aplicar una paleta específica, usa:');
        $this->line('php artisan theme:apply-pastel [nombre-paleta]');
        $this->line('');
        $this->line('Ejemplos:');
        $this->line('php artisan theme:apply-pastel lavender');
        $this->line('php artisan theme:apply-pastel mint');
        $this->line('php artisan theme:apply-pastel peach');
