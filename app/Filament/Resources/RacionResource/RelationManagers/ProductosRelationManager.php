...
namespace App\Filament\Resources\RacionResource\RelationManagers;

use App\Models\Producto;
use App\Models\ProductoPorRacion;
use Filament\Forms;
...
{
    protected static string $relationship = 'productosPorRacion';

    protected static ?string $title = 'Productos de la Ración';
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Información del Producto')
                    ...
                    ->columns(2),
                Forms\Components\Section::make('Cantidad')
                    ->schema([
                        Forms\Components\TextInput::make('cantidad')
                            ...
                            ->minValue(1)
                            ->default(1)
                            ->helperText('Ingrese la cantidad de este producto en la ración'),
                    ]),
            ]);
    }
